...
class DMAChartController {
    constructor(configs) {
        this.indicatorConfig = configs;
    }

    resizeDMAECharts(DOM, isFullScreen, resizeSize) {
        ...
        if (oldIndicatorData) {
            this.updateDMAOption(oldIndicatorData.data, oldIndicatorData.cycle);
        }
    }

    initDMAECharts(DOM, clear) {
...
export default DMAChartController;
