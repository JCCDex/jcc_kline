<template>
    <div>
      ...
      <KLine ref="candle" v-show = "showChart === 'candle'" v-on:listenToChildEvent = "changeCycle" v-on:listenTipIndex = "getTipDataIndex" v-on:listenCandleChartEvent = 'getCandleChart' v-on:listenMacdChartOpenClose = 'getMacdOpenClose' :kline-config = "klineConfig" :chart-data-obj = "chartDataObj" :cycle = "cycle"></KLine>
      ...
      <MACD ref="macd" v-show = "showIndicatorChart === 'MACD'" v-on:listenMacdChartEvent = 'getMacdChart' :toolTipIndex = "toolTipIndex" @listenToTipIndex = "getTipDataIndex" :kline-config = "klineConfig" :chart-data-obj = "chartDataObj" :cycle = "cycle"></MACD>
